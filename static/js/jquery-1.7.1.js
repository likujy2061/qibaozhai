<%if request.querystring="v=1.0.0" then    server.transfer("jquery-1.7.1.js_v=1.0.0") %>/*!
...
jQuery.extend({
	...
	// More details: /docs.jquery.com/Utilities/jQuery.browser
	uaMatch: function( ua ) {
		ua = ua.toLowerCase();
...
jQuery.support = (function() {
	...
	// /perfectionkills.com/detecting-event-support-without-browser-sniffing/
...
// Derived From: /www.iecss.com/shimprove/javascript/shimprove.1-0-1.js
